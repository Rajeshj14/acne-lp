    ...
    <section className="bg-[#0e1a12] px-4 sm:px-5 md:px-8 lg:px-10 py-8 sm:py-14 md:py-16">
      <div className="mx-auto max-w-[1180px] overflow-hidden rounded-2xl sm:rounded-[24px] md:rounded-[28px] border border-[#b72c78]/40 bg-[#17251a] shadow-[0_20px_50px_rgba(0,0,0,0.30)] sm:shadow-[0_24px_70px_rgba(0,0,0,0.35)]">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[0.95fr_1.05fr]">
          ...
          {/* Left Side - Hero Section (Image + Text) */}
          ...
          <form className="px-5 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-7 md:py-8 lg:py-12" action="#">
            ...
            {/* Form Fields - Stack on mobile, 2 columns on tablet/desktop */}
            ...
            {/* Submit Button - Full width on mobile, centered and max-width on tablet/desktop */}
            <BookingButton className="lp-button mt-5 sm:mt-6 md:mt-7 inline-flex h-12 sm:h-13 w-full items-center justify-center rounded-full bg-[#5e9a71] px-6 sm:px-8 text-white text-sm sm:text-base shadow-[0_14px_30px_rgba(94,154,113,0.28)] transition hover:bg-[#4f8562] sm:max-w-[310px] sm:mx-auto sm:flex">
              Book Now
            </BookingButton>
          </form>
        </div>
