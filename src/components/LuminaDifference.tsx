...
const cases = [
  ...
  },
  {
    ...
    area: 'Full Face',
    treatment: 'Acne Control Protocol',
    sessions: '6 Sessions',
    duration: '3.5 Months',
    result: '88%',
    resultLabel: 'Breakouts Controlled',
    quote: 'My breakouts are finally under control, and the doctor explained every step patiently.',
  },
  {
    before: '/ACNI-06.jpeg',
    after: '/ACNI-07.jpeg',
